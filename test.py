...
from add import clsAddEmployeeWindow
from informa import clsShowEmpInfo
from update import clsUpdatEmp
from find import clsFindEmpWindow
from delete import clsDeletEmpWindow
